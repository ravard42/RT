...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/05/22 12:16:51 by owinckle          #+#    #+#             */
/*   Updated: 2017/05/23 02:13:19 by dbirtel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rt.h"

static void		cone_child(t_obj *o, xmlNodePtr noeud, t_env *e)
{
	(void)e;
...
void			load_co_effect(t_obj *o, xmlNodePtr noeud)
{
	xmlChar		*attr;
...
void			load_cone(t_obj *o, xmlNodePtr noeud, t_env *e)
{
	...
	if ((attr = xmlGetProp(noeud, (const xmlChar *)"rad")))
		if (ft_isdigit(*(char *)attr))
			o->rad = ft_atof((char *)attr, 1) / 180.0 * M_PI;
	...
	load_co_effect(o, noeud);
	cone_child(o, noeud, e);
}
